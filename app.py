...
from about_cdss import about_page

# Load trained RNN model
rnn_model = load_model('model/CDSS_RNN.h5')
...
st.set_page_config(
    ...
    page_icon="🩺",
    layout="wide",  # This sets the layout to occupy the entire screen
)
...
def main():
    ...
    if selected == "Home":
        ...
        st.markdown("Navigate to the **About** page to learn more about how CDSS works.")
        ...
        symptom_list = features[:-1].values.flatten().tolist() 
...
def display_disease_info(prediction):
    ...
    with tabs[1]:
        ...
        with col1:
            ...
            specialist = info['Consulting Specialist']
            if specialist:
